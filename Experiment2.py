...
class Spring:
    ...
    def __form__graph__(self):
        f = open('./spring2019/ds2996_student_step_All_Data_4943_2019_1023_033330.txt', 'r')
...
class Experiment3:
    def __init__(self, new_try=True):
        if new_try:
            gotry = Spring()
            pickle.dump(gotry, open('gotry3.pkl', 'wb'))
        else:
            gotry = pickle.load(open('gotry3.pkl', 'rb'))
        self.gotry = gotry
    ...
    def train_by_sensitive(self):
        r1 = RandL1Embed(self.student_num, self.concept_num, target_space_n=7, lr=0.01)
        r1.train_now(train=self.train_graph)
        self.r1 = r1
        return r1

    def train_by_transe(self):
        r2 = RandL2Embed(self.student_num, self.concept_num, target_space_n=7, lr=0.01)
        r2.train_now(train=self.train_graph)
        self.r2 = r2
        return r2

    def train_by_feature_l1(self, target_space_n=13):
        f1 = FeatureL1Embed(self.student_num, self.concept_num, target_space_n=target_space_n, lr=0.002)
        f1.train_now(train=self.train_graph, nound=5500)
        self.f1 = f1
        return f1

    def train_by_svd(self):
        s1 = SvdEmbed(self.student_num, self.concept_num, target_space_n=8, lr=0.01)
        s1.train_now(train=self.train_graph)
        self.s1 = s1
        return s1

    def train_by_biasSvd(self):
        s2 = BiasSvdEmbed(self.student_num, self.concept_num, target_space_n=8, lr=0.01)
        s2.train_now(train=self.train_graph)
        self.s2 = s2
        return s2

    def train_by_ufilter(self):
        u1 = UserFilter(self.student_num, self.concept_num)
        u1.train_now(train=self.train_graph)
        self.u1 = u1
        return u1

    def train_by_ifilter(self):
        i1 = ItemFilter(self.student_num, self.concept_num)
        i1.train_now(train=self.train_graph)
        self.i1 = i1
        return i1

    def train_by_lstmKC(self):
        l1 = lstmKC(self.student_num, self.concept_num, target_space=8, lr=0.01)
        l1.train_now(train=self.train_graph, nround=500)
        self.l1 = l1
        return l1

exper3 = Experiment3(new_try=False)
# # random l1
# r1 = exper3.train_by_sensitive()
# # # # random l2
# r2 = exper3.train_by_transe()
# # # feature l1
# # #
f1 = exper3.train_by_feature_l1(8)
# # # #
s1 = exper3.train_by_svd()
s2 = exper3.train_by_biasSvd()
u1 = exper3.train_by_ufilter()
i1 = exper3.train_by_ifilter()
l1 = exper3.train_by_lstmKC()

# acc_r1, mse_r1, prediction_r1 = r1.test_now(exper3.test_graph)
# acc_r2, mse_r2, prediction_r2 = r2.test_now(exper3.test_graph)
# acc_f1, mse_f1, prediction_f1 = f1.test_now(exper3.test_graph, T=0.51)
# acc_s1, mse_s1, prediction_s1 = s1.test_now(exper3.test_graph)
# acc_s2, mse_s2, prediction_s2 = s2.test_now(exper3.test_graph)
# acc_u1, mse_u1, prediction_u1 = u1.test_now(exper3.test_graph)
# acc_i1, mse_i1, prediction_i1 = i1.test_now(exper3.test_graph)
# acc_l1, mse_l1, prediction_l1 = l1.test_now(exper3.test_graph)


# acc_r1_5 = TopK(model=r1, test=exper3.test_graph, student_num=exper3.student_num).top_k(5)
# acc_r1_10 = TopK(model=r1, test=exper3.test_graph, student_num=exper3.student_num).top_k(10)
# acc_r2_5 = TopK(model=r2, test=exper3.test_graph, student_num=exper3.student_num).top_k(5)
# acc_r2_10 = TopK(model=r2, test=exper3.test_graph, student_num=exper3.student_num).top_k(10)
acc_f1_5 = TopK(model=f1, test=exper3.test_graph, student_num=exper3.student_num).top_k(5)
acc_f1_10 = TopK(model=f1, test=exper3.test_graph, student_num=exper3.student_num).top_k(10)
acc_s1_5 = TopK(model=s1, test=exper3.test_graph, student_num=exper3.student_num).top_k(5)
acc_s1_10 = TopK(model=s1, test=exper3.test_graph, student_num=exper3.student_num).top_k(10)
acc_s2_5 = TopK(model=s2, test=exper3.test_graph, student_num=exper3.student_num).top_k(5)
acc_s2_10 = TopK(model=s2, test=exper3.test_graph, student_num=exper3.student_num).top_k(10)
acc_u1_5 = TopK(model=u1, test=exper3.test_graph, student_num=exper3.student_num).top_k(5)
acc_u1_10 = TopK(model=u1, test=exper3.test_graph, student_num=exper3.student_num).top_k(10)
acc_i1_5 = TopK(model=i1, test=exper3.test_graph, student_num=exper3.student_num).top_k(5)
acc_i1_10 = TopK(model=i1, test=exper3.test_graph, student_num=exper3.student_num).top_k(10)
acc_l1_5 = TopK(model=l1, test=exper3.test_graph, student_num=exper3.student_num).top_k(5)
acc_l1_10 = TopK(model=l1, test=exper3.test_graph, student_num=exper3.student_num).top_k(10)
